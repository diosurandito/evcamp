    ...
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
        <h1 class="flex-sm-fill h3 my-2">
          Menu Data Akun Penyelenggara
        </h1>
        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-alt">
            <li class="breadcrumb-item">Admin</li>
            <li class="breadcrumb-item" aria-current="page">
              <a class="link-fx" href="">Akun Penyelenggara</a>
            </li>
          </ol>
        </nav>
      </div>
  ...
  <div class="content">
    ...
    <div class="block">
      <div class="block-header" style="background: #344675;">
        <h3 class="block-title text-white">Data Penyelenggara</h3>
      </div>
              ...
              <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                  <div class="block-header bg-amethyst-dark">
                    <h3 class="block-title">Hapus Data Penyelenggara</h3>
                  ...
                  <div class="block-content block-content-full text-right border-top">
                    ...
                    <a href="organizer/destroy/{{ $data->id }}" class="btn btn-danger text-white">Hapus</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                  <div class="block-header bg-info">
                    <h3 class="block-title">Detail Data Penyelenggara</h3>
                    <div class="block-options">
                      <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-fw fa-times"></i>
                      </button>
                  ...
                  <div class="block-content font-size-sm">
                    <div class="row">
                      <div class="col-lg-8 col-xl-12">
                        <form action="{{ route('admin.organizer.show', $data->id) }}" method="post">
                          @csrf
                          @method('GET')
                          <div class="p-3 text-center bg-amethyst-light">
                            <img class="img-avatar img-avatar100 img-avatar-thumb" src="{{ asset('public/images/'.$data->foto) }}" alt="" style="width: 100px; height: 100px">
                          </div><br>
                          <div class="form-group row">
                            ...
                            <div class="col-6">
                              <label for="">Nama Bank Penyelenggara</label>
                              <input type="text" class="form-control" value="{{$data->nama_bank}}" name="nama_bank" readonly>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <label for="">Nama Akun Bank Penyelenggara</label>
                              <input type="text" class="form-control" value="{{$data->nama_akun}}" name="nama_akun" readonly>
                            </div>
                            <div class="col-6">
                              <label for="">Nama Kampus Penyelenggara</label>
                              <input type="text" class="form-control" value="{{$data->nama_kampus}}" name="nama_kampus" readonly>
                            </div>
                            <div class="col-6">
                              <label for="">Nomor Rekening Penyelenggara</label>
                              <input type="text" class="form-control" value="{{$data->no_rek}}" name="no_rek" readonly>
                            </div>
                            <div class="col-6">
                              <label for="">Foto KTM / ID Pengenal</label><br>
                              <img class="col-12" src="{{ asset('public/images/'.$data->foto_ktm) }}" alt=""/>
                            </div>
          ...
          <div class="modal fade" id="reset_password{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                  <div class="block-header" style="background: #344675;">
                    <h3 class="block-title">Reset Password Penyelenggara</h3>
                    <div class="block-options">
                      <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-fw fa-times"></i>
                      </button>
                  ...
                  <div class="block-content font-size-sm">
                    <div class="row">
                      <div class="col-lg-8 col-xl-12">
                        <form action="{{ route('admin.organizer.reset', $data->id) }}" method="post">
                          @csrf
                          @method('PATCH')
