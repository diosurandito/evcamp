...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan register untuk menggunakan aplikasi</p>
    ...
    <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nama Kampus" name="nama_kampus" value="{{ old('nama_kampus') }}" required autofocus>
